      ...
      <div className='services container' data-aos='fade-up'>
        ...
        <div className='row my-5'>
          <div className='col-md-2 col-6 text-center service p-3 d-flex align-items-center flex-column justify-content-center'>
            <img
              src='images/Floral-Arrangement.svg'
              width='60px'
              alt=''
              srcSet=''
            />
        ...
        <Slider {...settings}>
          <div className='col event'>
            ...
            <div className='content col-8 text-center'>
              <h3>Iftaar</h3>
              <p>
                Indulge in our delicious Iftar buffets during the month of
                Ramadan, with ample spaces in our banquets and restaurant to
                host Iftar dinners.
              </p>
            </div>
          </div>
          <div className='col event'>
            ...
            <div className='content col-8 text-center'>
              <h3>Family Events</h3>
              <p>
                Celebrate family milestones with an unforgettable experience in
                our venues, where you can choose your own personalized menu,
                setting, decor and group activites
              </p>
            </div>
          </div>
          <div className='col event'>
            ...
            <div className='content col-8 text-center'>
              ...
              <p>
                Host musical nights in one of our spacious and grand banquets
                for a lively night of music, joy and laughter.
              </p>
            </div>
          </div>
          <div className='col event'>
            ...
            <div className='content col-8 text-center'>
              ...
              <p>
                Celebrate your loved ones' birthdays in a magical outdoor or
                indoor setting.
              </p>
            </div>
          </div>
          <div className='col event'>
            ...
            <div className='content col-8 text-center'>
              ...
              <p>
                Corporate events are a time to bring people together. Whether
                it’s for networking or building up the company’s spirit, there
                is no better way to meet people than over some food and drinks.
                We have a large food selection and setup options that will cater
