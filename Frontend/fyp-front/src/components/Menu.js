  ...
  return (
    <div className='menu container'>
      ...
      <div className='row family'>
        ...
        <div
          className='col-md-5 mt-3 mt-md-0 d-flex flex-column align-items-center justify-content-center'
          data-aos='fade-left'
        >
      ...
      <div className='row table'>
        ...
        <div
          className='col-md-5 mt-3 mt-md-0 order-md-1 d-flex flex-column align-items-center justify-content-center'
          data-aos='fade-right'
        >
          <h4>Table service</h4>
          <p className='mt-3'>
      ...
      <div className='menu-gallery' data-aos='fade-up'>
        ...
        <div className='row'>
          <div
            className='col-sm-6 col-md-3 mt-3 mt-md-0'
            data-toggle='modal'
