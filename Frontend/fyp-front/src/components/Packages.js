...
function Packages() {
    return (
        <div className="packages container">
            ...
            <h1 className="text-center mb-5 display-4">Wedding Menu</h1>

            <div className="row">
                <div className="col-sm-6 col-md-4 mt-3 d-flex align-items-stretch">
            ...
            <h2 className="text-center mb-0 mt-5 diamond"><img src="images/diamond.svg" width="20px" alt="" srcset="" /></h2>
            <h1 className="mb-5 text-center display-4">Dessert Selection</h1>
            <div className="row text-center d-flex">
                <div className="col-6 col-sm-4 col-lg-2 my-1 d-flex flex-column  align-items-stretch">
            ...
            <h2 className="text-center mb-0 mt-5 diamond"><img src="images/diamond.svg" width="20px" alt="" srcset="" /></h2>
            <h1 className="text-center mb-5 display-4">Corporate Menu</h1>

            <div className="row">
                <div className="col-sm-6 col-lg-4 mt-3 d-flex align-items-stretch">
                    <div className="col-12 wm-proposal p-5">
                        <h3>CM Package 1</h3>
